...
const CustomerDetails = () => {
    ...
    async function fetchTransactionList() {
        try {
            const res = await get(`https://tgc67.online/api/resource/GL%20Entry?filters=[["account", "=", "Creditors - TGC"],["party_type","=","Supplier"],["party", "=", "${name}"]]&fields=["posting_date","account","debit_in_account_currency","credit_in_account_currency","against","voucher_no"]&limit=20&order_by=posting_date&limit_start=0`);
    ...
    const handleRowClick = (rowData) => {
        ...
        router.push(`/purchase/invoice/view/${voucherNo}`);
    };
